-- @name: osu! — Punishing
-- @game: osu!
-- @description: Silence while you play well — only mistakes buzz. Meh hits tickle, misses sting, failing hits full power.
...
-- ── Tuning ───────────────────────────────────────────────────────────────────
local LEVEL = { meh = 0.10, ok = 0.0, great = 0.0, perfect = 0.0, miss = 0.75, fail = 1.0 }
local DUR   = { meh = 0.07, ok = 0.09, great = 0.11, perfect = 0.14, miss = 0.30 }
